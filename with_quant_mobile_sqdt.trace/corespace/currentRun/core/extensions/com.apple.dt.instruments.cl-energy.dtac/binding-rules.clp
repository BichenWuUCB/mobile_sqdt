...
(defrule binding-rule-1
    ...
    (bind-input-table kdebug (attribute target-pid $?target) (attribute codes "0x2d,*" ) (attribute callstack user))
...
(defrule binding-rule-2
    ...
    (bind-input-table kdebug (attribute target-pid $?target) (attribute callstack user) (attribute codes "0x2d,*" ))
    (assert (modeler-instance-param (instance ?instance__) (name target) (value ?target)))
)
